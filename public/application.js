...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEngineEvents = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gamesApi = __webpack_require__(10);
	var gamesUi = __webpack_require__(12);
	var autoSignInSuccess = __webpack_require__(12);
	var autoSignInFailure = __webpack_require__(12);

	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(this);
	  console.log('SignIn complete!');
	  event.preventDefault();
	  gamesApi.signIn(data).then(gamesUi.signInSuccess).catch(gamesUi.signInFailure);
	};

	var onSignUp = function onSignUp(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  gamesApi.signUp(data).then(gamesUi.signUpSuccess).then(function () {
	    gamesApi.autoSignIn(data).then(gamesUi.autoSignInSuccess).catch(gamesUi.autoSignInFailure);
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  gamesApi.signOut(data).then(gamesUi.signOutSuccess).catch(gamesUi.signOutFailure);
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  var data = getFormFields(event.target);
	  gamesApi.changePassword(data).then(gamesUi.changePasswordSuccess).catch(gamesUi.changePasswordFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var autoSignInSuccess = function autoSignInSuccess(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var userMessage = function userMessage(txt) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gamesApi = __webpack_require__(15);
	var gamesUi = __webpack_require__(16);
	var playerWinLogic = __webpack_require__(13);
	var getFormFields = __webpack_require__(9);
	...
	var onNewGame = function onNewGame(event) {
	  ...
	  gamesApi.createGame().then(gamesUi.createGameSuccess).catch(gamesUi.createGameError);
	  $(this).attr('id');
	};
	...
	var resetBoard = function resetBoard(event) {
	...
	var onGetGames = function onGetGames(event) {
	  ...
	  var game = data.game;
	  if (game.id.length !== 0) {
	    gamesApi.show(game.id).then(gamesUi.onGetGamesSuccess).catch(gamesUi.onGetGamesError);
	  } else {
	...
	var onUpdateGame = function onUpdateGame(event) {
	  ...
	  var data = getFormFields(event.target);
	  gamesApi.updateGame(data).then(gamesUi.onUpdateSuccess).catch(gamesUi.onUpdateError);
	};

	var onGetStats = function onGetStats(event) {
	  event.preventDefault();
	  console.log('onGetStats fired');
	  gamesApi.getGame().then(gamesUi.getGamesSuccess).catch(gamesUi.getGamesFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(index, value, gameOver) {
	...
	var getGameIndex = function getGameIndex() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createGameError = function createGameError(response) {
	  console.error(response);
	  logic.userMessage('Something went wrong, please try again.');
	  $('.board').hide();
	};

	var resetBoardSuccess = function resetBoardSuccess(data) {
	  console.log('game created');
	  store.game = data.game;
	...
	var resetBoardFailure = function resetBoardFailure(data) {
	  console.log('game created');
	  store.game = data.game;
	  logic.userMessage('Something went wrong, please try again.');
	  $('.board').hide();
	...
	var onUpdateFailure = function onUpdateFailure(response) {
	  console.error(response);
	  logic.userMessage('Something went wrong, please try again.');
	};
	...
	module.exports = {
	  ...
	  resetBoardSuccess: resetBoardSuccess,
	  resetBoardFailure: resetBoardFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
